...
public class ArticleController {
    ...
    public ServerResponse<NewArticleDTO> getArticle(@PathVariable Integer id) {
    ...
    public ServerResponse<NewArticleDTO> getLabelAndSortInfo() {
    ...
    public ServerResponse<String> writeArticle(@RequestBody NewArticleDTO newArticleDTO) {
        System.out.println(newArticleDTO);
        return articleService.createNewArticle(newArticleDTO);
    }
